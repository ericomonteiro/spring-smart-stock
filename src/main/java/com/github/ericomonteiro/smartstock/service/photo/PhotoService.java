...
public class PhotoService {
    ...
    public void addPhotoToProduct(Long productId, MultipartFile file, Boolean main) throws IOException {
    ...
    public byte[] getMainPhoto(Long productId) {
        Product product = productService.getAndValidProduct(productId);
        var photo = product
                .getAlbum()
                .stream()
                ...
                .findFirst()
                .orElseThrow(() -> new BusinessException(ErrorKeys.Product.DETAIL_NOT_BLANK));
